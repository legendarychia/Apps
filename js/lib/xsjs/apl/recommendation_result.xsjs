...
function doPost() {
  ...
  try {
    ...
    if (typeof $.request.body !== "undefined") {
      ...
      if (typeof requestBody.APPID !== "undefined") {
        params.APPID = requestBody.APPID;
      }
    ...
    var algorithm = connection.loadProcedure(null, "aa.apps.db.hdb.apl.procedure::recommendation_result_" + resultType);
